<?php 
class Billing_Model_ArticleSupplyFilter extends Tinebase_Model_Filter_FilterGroup
{
    /**
    ...
    protected $_className = 'Billing_Model_ArticleSupplyFilter';
    ...
    protected $_filterModel = array(
        ...
        'query'                => array(
            ...
            'options' => array('fields' => array('amount'))
        ),
    );
}
?>