...
/**
 * class to hold BatchJobMonitionItem data
 *
 * @package     Billing
 */
class Billing_Model_BatchJobMonitionItem extends Tinebase_Record_Abstract
{
    /**
    ...
    protected $_validators = array(
        'id'                    => array(Zend_Filter_Input::ALLOW_EMPTY => true, Zend_Filter_Input::DEFAULT_VALUE => NULL),
       	'batch_monition_id'                  => array(Zend_Filter_Input::ALLOW_EMPTY => true),
