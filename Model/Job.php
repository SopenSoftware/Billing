 ...
 * @package     Billing
 */
class Billing_Model_Job extends Tinebase_Record_Abstract
{
    /**
    ...
    protected $_validators = array(
    	...
    	'name'                  => array(Zend_Filter_Input::ALLOW_EMPTY => true, Zend_Filter_Input::DEFAULT_VALUE => 0),
	    'description'                  => array(Zend_Filter_Input::ALLOW_EMPTY => true),
	    'budget_amount'                  => array(Zend_Filter_Input::ALLOW_EMPTY => true),
       	'budget_unit_id'                  => array(Zend_Filter_Input::ALLOW_EMPTY => true),
    	'finish_date'                  => array(Zend_Filter_Input::ALLOW_EMPTY => true),
        // modlog
