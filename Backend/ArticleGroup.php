<?php
class Billing_Backend_ArticleGroup extends Tinebase_Backend_Sql_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_tableName = 'bill_article_group';
     ...
     * @var string
     */
    protected $_modelName = 'Billing_Model_ArticleGroup';
