<?php
class Billing_Backend_PaymentMethod extends Tinebase_Backend_Sql_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_tableName = 'bill_payment_method';
     ...
     * @var string
     */
    protected $_modelName = 'Billing_Model_PaymentMethod';
