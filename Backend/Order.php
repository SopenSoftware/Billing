<?php
class Billing_Backend_Order extends Tinebase_Backend_Sql_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_tableName = 'bill_order';
    ...
    {  
        ...
        $select->joinLeft($this->_tablePrefix . 'bill_debitor',
			$this->_db->quoteIdentifier($this->_tablePrefix . 'bill_debitor.id') . ' = ' . $this->_db->quoteIdentifier($this->_tableName.'.debitor_id'),
        array());
        
        $select->joinLeft($this->_tablePrefix . 'addressbook',
			$this->_db->quoteIdentifier($this->_tablePrefix . 'bill_debitor.contact_id') . ' = ' . $this->_db->quoteIdentifier($this->_tablePrefix . 'addressbook.id'),
        array());
