<?php
class Billing_Backend_BatchJobDtaItem extends Tinebase_Backend_Sql_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_tableName = 'bill_batch_dta_item';
     ...
     * @var string
     */
    protected $_modelName = 'Billing_Model_BatchJobDtaItem';
