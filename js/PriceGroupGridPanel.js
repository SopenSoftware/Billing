 ...
 */
Tine.Billing.PriceGroupGridPanel = Ext.extend(Tine.widgets.grid.GridPanel, {
	id: 'tine-billing-priceGroup-gridpanel',
    ...
    initComponent: function() {
        this.recordProxy = Tine.Billing.priceGroupBackend;
        ...
        Tine.Billing.PriceGroupGridPanel.superclass.initComponent.call(this);
    },
    initFilterToolbar: function() {
		var quickFilter = [new Tine.widgets.grid.FilterToolbarQuickFilterPlugin()];	
		this.filterToolbar = new Tine.widgets.grid.FilterToolbar({
            app: this.app,
            filterModels: Tine.Billing.Model.PriceGroup.getFilterModel(),
            defaultFilter: 'query',
