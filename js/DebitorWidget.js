Tine.Billing.DebitorWidget = function(config) {
    Ext.apply(this, config);
    Tine.Billing.DebitorWidget.superclass.constructor.call(this);
};

Ext.extend(Tine.Billing.DebitorWidget, Ext.Panel, {
	editDialog: null,
	ddConfig:{
    	ddGroupDebitor: 'ddGroupDebitor',
    	ddGroupGetDebitor: 'ddGroupGetDebitor'
    },
	initComponent: function(){
		...
		Tine.Billing.DebitorWidget.superclass.initComponent.call(this);
		//this.editDialog.on('loaddebitor',this.onLoadDebitor,this);
	},
    /**
    ...
    initDefaultTemplate: function() {
        this.defaultTpl = new Ext.XTemplate(
                ...
                '<div class="preview-panel preview-panel-timesheet-left">',
                    '<div class="preview-panel-declaration">Debitors</div>',
        ...
        this.tpl = new Ext.XTemplate(
            '<tpl for=".">',
                 ...
                 '<div class="contact-widget-contact">',
                	'<span class="preview-panel-bold">Kreditor-Nr: {[this.encode(values.debitor_nr, "mediumtext")]}</span><br/>',
    ...
    initDropZone: function(){
		...
		this.dd = new Ext.dd.DropTarget(this.el, {
			scope: this,
			ddGroup     : this.ddConfig.ddGroupDebitor,
		...
		this.dd.addToGroup(this.ddConfig.ddGroupGetDebitor);
	}
});

Ext.reg('contactwidget',Tine.Billing.DebitorWidget);