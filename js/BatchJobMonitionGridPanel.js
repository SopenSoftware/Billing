...
Tine.Billing.getBatchJobMonitionGridConfig = function(app){
	return {
	    recordClass: Tine.Billing.Model.BatchJobMonition,
		recordProxy: Tine.Billing.Model.batchJobMonitionBackend,
		columns: [
		   ...
		   { header: app.i18n._('Mahnbeleg'), dataIndex: 'monition_receipt_id', sortable:true
			   },
		   { header: app.i18n._('Mahnstufe'), dataIndex: 'monition_stage', sortable:true,
			   editor: new Ext.form.TextField()},
		   { header: app.i18n._('Gesamtbetrag'), dataIndex: 'total_sum',renderer: Sopen.Renderer.MonetaryNumFieldRenderer, sortable:true },
		   { header: app.i18n._('offener Betrag'), dataIndex: 'open_sum',renderer: Sopen.Renderer.MonetaryNumFieldRenderer, sortable:true
			   },
		   ...
		   { header: app.i18n._('Mahnsperre'), dataIndex: 'monition_lock', sortable:true},
...
Tine.Billing.BatchJobMonitionGridPanel = Ext.extend(Tine.widgets.grid.GridPanel, {
	id: 'tine-billing-batch-job-monition-gridpanel',
	//stateId: 'tine-billing-batch-job-monition-gridpanel-state',
    recordClass: Tine.Billing.Model.BatchJobMonition,
    evalGrants: false,
    // grid specific
    ...
    initComponent: function() {
        ...
        this.recordProxy = Tine.Billing.batchJobMonitionBackend;
        ...
        Tine.Billing.BatchJobMonitionGridPanel.superclass.initComponent.call(this);
    },
    initActions: function(){
    	 
    	 this.actions_openBatchJobMonitionItemContact = new Ext.Action({
             actionType: 'edit',
             handler: this.openBatchJobMonitionItemContact,
             text: 'Öffne Kontakt',
             iconCls: 'actionEdit',
             scope: this
         });
    ...
    getActionToolbarItems: function() {
    	return [
    	        this.actions_openBatchJobMonitionItemContact
        ];
    },
    ...
    initFilterToolbar: function() {
		...
		this.filterToolbar = new Tine.widgets.grid.FilterToolbar({
            app: this.app,
            filterModels: Tine.Billing.Model.BatchJobMonition.getFilterModel(),
            defaultFilter: 'query',
    ...
    getContextMenuItems: function(){
    	return [
    	        ...
    	        this.actions_openParentBatchJobMonitionItemContact,
    	        this.actions_openParentMember,
    	        this.actions_openChildBatchJobMonitionItemContact,
	...
	getColumns: function() {
    	return Tine.Billing.getBatchJobMonitionGridConfig(this.app).columns;
	},
	
	openBatchJobMonitionItemContact: function(){
    ...
    onStoreBeforeload: function(store, options) {
    	Tine.Billing.BatchJobMonitionGridPanel.superclass.onStoreBeforeload.call(this, store, options);
    	if(!this.useImplicitForeignRecordFilter){
    		return true;
    	}
