 ...
 */
Tine.Billing.BatchJobDtaItemGridPanel = Ext.extend(Tine.widgets.grid.GridPanel, {
	id: 'billing-batch-job-dta-item-grid-panel',
    ...
    initComponent: function() {
        this.recordProxy = Tine.Billing.batchJobDtaItemBackend;
        this.initFilterToolbar();
        //this.actionToolbarItems = this.getToolbarItems();
        this.gridConfig.columns = this.getColumns();
        Tine.Billing.BatchJobDtaItemGridPanel.superclass.initComponent.call(this);
    ...
    onStoreBeforeload: function(store, options) {
    	console.log(this);
    	Tine.Billing.BatchJobDtaItemGridPanel.superclass.onStoreBeforeload.call(this, store, options);
    	console.log(this);
    	...
    	if(this.batchJobDtaRecord){
    		filterOptions.record = this.batchJobDtaRecord;
        	filterOptions.field = 'batch_dta_id';
    ...
    onEditInNewWindow: function(button, event) {
        ...
        var popupWindow = Tine[this.app.appName][this.recordClass.getMeta('modelName') + 'EditDialog'].openWindow({
            record: record,
            batchJobDtaRecord: this.batchJobDtaRecord,
            grid: this,
            listeners: {
                scope: this,
    ...
    initFilterToolbar: function() {
		...
		this.filterToolbar = new Tine.widgets.grid.FilterToolbar({
            app: this.app,
            filterModels: Tine.Billing.Model.BatchJobDtaItem.getFilterModel(),
            defaultFilter: 'query',
	...
	getColumns: function() {
		return [
		   { header: this.app.i18n._('Betrag'), renderer: Sopen.Renderer.MonetaryNumFieldRenderer, dataIndex: 'total_sum'},
